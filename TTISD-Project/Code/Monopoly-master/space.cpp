...
void Space::setName(string inputName, string inputName2){
    name[0] = QString::fromStdString(inputName).trimmed().toStdString();
    name[1] = " " + QString::fromStdString(inputName2).trimmed().toStdString();
    houses = 0;
}

void Space::setActionText(string inputText, string inputText2){
    actionText[0] = QString::fromStdString(inputText).trimmed().toStdString();
    actionText[1] = " " + QString::fromStdString(inputText2).trimmed().toStdString();
    houses = 0;
}
