...
BottomBar::BottomBar() {
    ...
    layout->addWidget(player1Button, 1, 0, nullptr);
    layout->addWidget(player2Button, 1, 1, nullptr);
    layout->addWidget(player3Button, 1, 2, nullptr);
...
void BottomBar::endTurn() {
    ...
    if (numAlive <= 1) {
        ...
        QString _qText = QString::fromStdString(fullText);
        QString _qInfo = QString::fromStdString(informativeText);

        QMessageBox winnerDisplay;
        winnerDisplay.setText(_qText);
        winnerDisplay.setInformativeText(_qInfo);
        winnerDisplay.exec();
    }
