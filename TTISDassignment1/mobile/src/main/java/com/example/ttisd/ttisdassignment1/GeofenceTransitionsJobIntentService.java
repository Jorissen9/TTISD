...
public class GeofenceTransitionsJobIntentService extends JobIntentService {
    ...
    private void sendNotification(NotificationDescr notificationDetails) {
        ...
        for (String notydetails : notificationDetails.getDetails()) {
            ...
            builder.setSmallIcon(R.mipmap.ic_launcher)
                    ...
                    .setStyle(new NotificationCompat.BigTextStyle().bigText(notydetails))
            ...
            // Issue the notification, unique id => new notification
            mNotificationManager.notify(notydetails.hashCode(), builder.build());
        }
    }
